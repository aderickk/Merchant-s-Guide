...
class MenuFiltererTest {
	...
	void test_file_handle() {
		String testCase = "LOAD " + System.getProperty("user.dir") + "\\fileTest\\complicated_test_1.txt";
		
		StringBuilder expectedResult = new StringBuilder();
		
		expectedResult.append("glob is I\r\n");
		expectedResult.append("prok is V\r\n");
		expectedResult.append("pish is X\r\n");
		expectedResult.append("tegj is L\r\n");
		expectedResult.append("glob glob Silver is 34 Credits\r\n");
		expectedResult.append("glob prok Gold is 57800 Credits\r\n");
		expectedResult.append("pish pish Iron is 3910 Credits\r\n");	
				
		expectedResult.append("how much is pish tegj glob glob ?\r\n");
		String expectedResult1 = "pish tegj glob glob is 42\r\n";
		expectedResult.append(expectedResult1);
		
		expectedResult.append( "how many Credits is glob prok Silver ?\r\n");
		String expectedResult2 = "glob prok Silver is 68 Credits\r\n";
		expectedResult.append(expectedResult2);
		
		expectedResult.append("how many Credits is glob prok Gold ?\r\n");
		String expectedResult3 = "glob prok Gold is 57800 Credits\r\n";
		expectedResult.append(expectedResult3);
		
		expectedResult.append("how many Credits is glob prok Iron ?\r\n");
		String expectedResult4 = "glob prok Iron is 782 Credits\r\n";
		expectedResult.append(expectedResult4);
		
		expectedResult.append("how much wood could a woodchuck chuck if a woodchuck could chuck wood ?\r\n");
		String expectedResult5 = "I don't know what you're talking about.\r\n";
		expectedResult.append(expectedResult5);
		
		try {
			mf.handleReadFiles(testCase);
		} catch(MerchantsException e) {
			// do nothing
		}
